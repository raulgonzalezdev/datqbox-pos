      ...
      <Card width={{ base: 'auto', md: '100%' }}>
        <CardBody width={{ base: 'auto', md: '100%' }} h="100%">
          <Flex flexDirection="column">
            <StyledText fontSize={{ base: '14px', md: '16px' }} mb={{ base: '2', md: '0' }}>
              Images Adicionales
            </StyledText>

            <SimpleGrid columns={{ base: 1, sm: 2, md: 2, lg: 2, xl: 2, '2xl': 2 }} spacing={4}>
              {thumbs}
            </SimpleGrid>
          </Flex>
        </CardBody>
        ...
        <Flex direction="row" justify="space-between">
          ...
          <DeleteAlert
            ...
            mutation={isDeletingAllImages ? REMOVE_PRODUCT_IMAGES : REMOVE_IMAGE}
          ...
          <Box
            ...
            justifyContent="center"
          >
            <Input placeholder="Upload Images..." textAlign="center" color="white" border="none" cursor="pointer" />

            <input placeholder="Arrastre y suelte aquí las imágenes" {...getInputProps()} style={{ display: 'none' }} />
          </Box>
        </Flex>

        <Box mt={4}>
          <HStack width="100%" justifyContent="space-between">
            <Button colorScheme="teal" size={{ base: 'sm', md: 'md' }} onClick={() => handleRemoveImage(imageId)}>
              Remove
            </Button>

            <Button colorScheme="teal" size={{ base: 'sm', md: 'md' }} onClick={() => handleRemoveProductImages(productId)}>
              Remove All
            </Button>
          </HStack>
        </Box>
